...
$env:BA_SR = $sr
Write-Host ("[auth] service_role prefix: " + $sr.Substring(0, 12))
& "C:\Users\zhang\AppData\Local\Programs\Python\Python310\python.exe" "C:\Projects\brainactive-android\revamp\upload_passing.py"
