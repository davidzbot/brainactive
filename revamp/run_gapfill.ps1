...
'@
Add-Type -MemberDefinition $sig -Namespace Win32 -Name CredGapfill
$ptr = [IntPtr]::Zero
[Win32.CredGapfill]::CredRead("Supabase CLI:supabase", 1, 0, [ref]$ptr) | Out-Null
...
[Win32.CredGapfill]::CredFree($ptr)
...
& "C:/Users/zhang/AppData/Local/Programs/Python/Python310/python.exe" "C:/Projects/brainactive-android/revamp/bank/upload_gapfill.py"
