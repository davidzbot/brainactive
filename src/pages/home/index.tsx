...
const i18n = {
  en: {
    ...
    pro_sub: 'Unlimited Practice · All 6 High Ability Domains · 4 Levels',
    ...
    usage_all_done: `✅ All ${MAX_TOTAL_DAILY_ROUNDS} Practice Rounds Completed Today`,
    ...
    extra_practice_limit: `Daily free limit reached (${MAX_TOTAL_DAILY_ROUNDS}/${MAX_TOTAL_DAILY_ROUNDS} rounds)`,
    ...
    referral_title: 'Share with Friends & Family',
    referral_sub: 'Love BrainActive? Share it with friends and family who enjoy thinking challenges.',
    referral_btn: 'Share',
  ...
  zh: {
    ...
    pro_sub: '无限特训 · 涵盖全部 6 大高能力领域 · 4 级难度',
    ...
    usage_all_done: `✅ 今日 ${MAX_TOTAL_DAILY_ROUNDS} 轮特训已全部完成`,
    ...
    extra_practice_limit: `今日特训次数已达上限 (${MAX_TOTAL_DAILY_ROUNDS}/${MAX_TOTAL_DAILY_ROUNDS})`,
    ...
    referral_title: '分享给亲友',
    referral_sub: '喜欢 BrainActive？分享给喜欢思维挑战的亲友们吧。',
    referral_btn: '分享',
    tips_title: '核心思维方法精讲',
    tips: [
